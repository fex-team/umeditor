 ...
 * google地图
 */
UE.registerUI('gmap',function(name){
 ...
 * 百度地图
 */
UE.registerUI('map',function(name){
 ...
 * 插入视频
 */
UE.registerUI('insertvideo',function(name){

    var me = this, currentRange, $dialog,
        opt = {
            title: (me.options.labelMap && me.options.labelMap[name]) || me.getLang("labelMap." + name),
            url: me.options.UEDITOR_HOME_URL + 'dialogs/video/video.js'
        };
