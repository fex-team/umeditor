(function () {
    ...
    UM.registerWidget(widgetName, {
        ...
        ".edui-dialog-map .edui-map-button { border: 1px solid #ccc; float: left; height: 23px; width: 70px; cursor: pointer; margin: 0; font-size: 12px; line-height: 24px; text-align: center; }" +
