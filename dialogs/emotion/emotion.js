...
(function(){
    ...
    UE.registerWidget('emotion',{
        ...
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=emotion_url%>emotion.css\">" +
            ...
            "<span><%=lang_input_choice%></span>" +
            "<span><%=lang_input_Tuzki%></span>" +
            "<span><%=lang_input_lvdouwa%></span>" +
            "<span><%=lang_input_BOBO%></span>" +
            "<span><%=lang_input_babyCat%></span>" +
            "<span><%=lang_input_bubble%></span>" +
            "<span><%=lang_input_youa%></span>" +
            "</div>" +
            "<div id=\"eduiEmotionTabBodys\" class=\"edui-emotion-tabbody\">" +
            "<div id=\"eduiEmotionTab0\"></div>" +
            "<div id=\"eduiEmotionTab1\"></div>" +
            "<div id=\"eduiEmotionTab2\"></div>" +
            "<div id=\"eduiEmotionTab3\"></div>" +
            "<div id=\"eduiEmotionTab4\"></div>" +
            "<div id=\"eduiEmotionTab5\"></div>" +
            "<div id=\"eduiEmotionTab6\"></div>" +
            "</div>" +
            "</div>" +
